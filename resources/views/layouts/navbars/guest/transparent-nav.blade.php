{{-- <div class="container position-sticky z-index-sticky top-0">
    <div class="row">
        <div class="col-12">
            <nav
                class="navbar navbar-expand-lg  blur blur-rounded top-0  z-index-3 shadow position-absolute my-4 py-2 start-0 end-0 mx-4">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
                        @if (in_array(request()->route()->getName(), ['forgot-password', 'reset-password']))
                                    ...
                                    <div class="dropdown-menu dropdown-menu-animation dropdown-lg border-radius-xl p-3 mt-0 mt-lg-3"
                                        ...
                                        <div class="row d-lg-none">
                                            <div class="col-12 d-flex justify-content-center flex-column">
                                                ...
                                                <a href="{{ route('signup-basic') }}"
                                                    class="dropdown-item border-radius-md">
                                                    Basic
                                                </a>
                                                <a href="{{ route('signup-cover') }}"
                                                    class="dropdown-item border-radius-md">
                                                    Cover
                                                </a>
                                                ...
                                                <a href="{{ route('reset-basic') }}"
                                                    class="dropdown-item border-radius-md">
                                                    Basic
                                                </a>
                                                <a href="{{ route('reset-cover') }}"
                                                    class="dropdown-item border-radius-md">
                                                    Cover
                                                </a>
                                                ...
                                                <a href="{{ route('lock-basic') }}"
                                                    class="dropdown-item border-radius-md">
                                                    Basic
                                                </a>
                                                <a href="{{ route('lock-cover') }}"
                                                    class="dropdown-item border-radius-md">
                                                    Cover
                                                </a>
                                                    ...
                                                    <a class="dropdown-item py-2 ps-3 border-radius-md"
                                                        ...
                                                        <div class="d-flex">
                                                            <div class="icon h-10 me-3 d-flex mt-1">
                                                                <i
                                                                    class="ni ni-single-copy-04 text-gradient text-warning"></i>
                                                            </div>
                                                            <div
                                                ...
                                                <li
                                                    ...
                                                    <a class="dropdown-item py-2 ps-3 border-radius-md"
                                                        ...
                                                        <div class="d-flex">
                                                            <div class="icon h-10 me-3 d-flex mt-1">
                                                                <i
                                                                    class="ni ni-notification-70 text-gradient text-warning"></i>
                                                            </div>
                                                            <div
                                                                class="w-100 d-flex align-items-center justify-content-between">
                                                                <div>
