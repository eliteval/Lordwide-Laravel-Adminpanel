                    ...
                    <div class="dropdown-menu dropdown-menu-animation dropdown-lg border-radius-xl p-3 mt-0 mt-lg-3"
                                ...
                                <ul class="list-group">
                                    ...
                                    <li
                                        ...
                                        <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownSignUp">
                                            ...
                                            <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                href="{{ route('signin-illustration') }}">
                        ...
                        <div class="row d-lg-none">
                            <div class="col-12 d-flex justify-content-center flex-column">
                                ...
                                <a href="{{ route('signin-illustration') }}" class="dropdown-item border-radius-md">
                                    Illustration
                                </a>
                                <h6
                                    class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                                ...
                                <a href="{{ route('signup-illustration') }}" class="dropdown-item border-radius-md">
                                    Illustration
                                </a>
                                <h6
                                    class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                                ...
                                <a href="{{ route('reset-illustration') }}" class="dropdown-item border-radius-md">
                                    Illustation
                                </a>
                                <h6
                                    class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                                ...
                                <a href="{{ route('lock-illustration') }}" class="dropdown-item border-radius-md">
                                    Illustration
                                </a>
                                <h6
                                    class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                                ...
                                <a href="{{ route('verification-basic') }}" class="dropdown-item border-radius-md">
                                    Basic
                                </a>
                                <a href="{{ route('verification-cover') }}" class="dropdown-item border-radius-md">
                                    Cover
                                </a>
                    ...
                    <div class="dropdown-menu dropdown-menu-animation dropdown-lg border-radius-xl p-3 mt-0 mt-lg-3"
                        ...
                        <div class="d-none d-lg-block">
                            <ul class="list-group">
                                <li
                                    class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                    <a class="dropdown-item py-2 ps-3 border-radius-md" href="{{ route('kanban') }}">
                                        <div class="d-flex">
                                ...
                                <li
                                    class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                    <a class="dropdown-item py-2 ps-3 border-radius-md" href="{{ route('wizard') }}">
                                        <div class="d-flex">
                                            <div class="icon h-10 me-3 d-flex mt-1">
                    ...
                    <div class="dropdown-menu dropdown-menu-animation dropdown-lg mt-0 mt-lg-3 p-3 border-radius-lg"
                        ...
                        <div class="d-none d-lg-block">
                            <ul class="list-group">
                                ...
                                <li class="nav-item list-group-item border-0 p-0">
                                    <a class="dropdown-item py-2 ps-3 border-radius-md"
                                        href="/documentation/bootstrap/colors/soft-ui-dashboard/index.html"
                                        target="_blank">
                                        <div class="d-flex">
                                            <div class="icon h-10 me-3 d-flex mt-1">
                                                <svg class="text-secondary" width="16px" height="16px"
                        ...
                        <div class="row d-lg-none">
                            <div class="col-md-12 g-0">
                                ...
                                <a class="dropdown-item py-2 ps-3 border-radius-md"
                                    href="/documentation/bootstrap/alerts/soft-ui-dashboard/index.html" target="_blank">
                                    <div class="d-flex">
                                        <div class="icon h-10 me-3 d-flex mt-1">
                                            <svg class="text-secondary" width="16px" height="16px" viewBox="0 0 40 44"
                                                version="1.1" xmlns="http://www.w3.org/2000/svg"
