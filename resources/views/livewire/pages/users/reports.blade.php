                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="dropdown text-end mb-6">
                                            <a class="cursor-pointer" id="dropdownUsers1" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                        ...
                        <div class="card"
                            ...
                            <div class="card-body p-3 position-relative">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="dropdown text-end mb-6">
                                            <a class="cursor-pointer" id="dropdownUsers2" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                                <i class="fa fa-ellipsis-h text-white"></i>
                                            </a>
                        ...
                        <div class="card"
                            ...
                            <div class="card-body p-3 position-relative">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="dropdown text-end mb-6">
                                            <a class="cursor-pointer" id="dropdownUsers3" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                                <i class="fa fa-ellipsis-h text-white"></i>
                                            </a>
                        ...
                        <div class="card"
                            ...
                            <div class="card-body p-3 position-relative">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="dropdown text-end mb-6">
                                            <a class="cursor-pointer" id="dropdownUsers4" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                                <i class="fa fa-ellipsis-h text-white"></i>
                                            </a>
