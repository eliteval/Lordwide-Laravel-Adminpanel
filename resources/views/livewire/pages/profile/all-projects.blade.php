                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card">
                                <div class="card-body p-3">
                                    ...
                                    <p class="text-sm mt-3"> If everything I did failed - which it doesn&#39;t, it
                                        actually succeeds. </p>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card">
                                <div class="card-body p-3">
                                    ...
                                    <p class="text-sm mt-3"> Pink is obviously a better color. Everyone’s born
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card">
                                <div class="card-body p-3">
                                    ...
                                    <p class="text-sm mt-3"> Constantly growing. We’re constantly making mistakes from
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card">
                                <div class="card-body p-3">
                                    ...
                                    <p class="text-sm mt-3"> You have the opportunity to play this game of life you need
