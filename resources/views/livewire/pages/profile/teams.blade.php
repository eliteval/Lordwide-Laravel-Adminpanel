                    ...
                    <div class="card-body d-flex row">
                        ...
                        <div class="col-1 text-center">
                            <a href="javascript:;" class="avatar avatar-lg rounded-circle border border-primary">
                                <img alt="Image placeholder" src="../../../assets/img/team-1.jpg" style="padding: 3px;">
                            </a>
                            <p class="mb-0 text-sm">Abbie W</p>
                        </div>
                        <div class="col-1 text-center">
                            <a href="javascript:;" class="avatar avatar-lg rounded-circle border border-primary">
                                <img alt="Image placeholder" src="../../../assets/img/team-2.jpg" style="padding: 3px;">
                            </a>
                            <p class="mb-0 text-sm">Boris U</p>
                        </div>
                        <div class="col-1 text-center">
                            <a href="javascript:;" class="avatar avatar-lg rounded-circle border border-primary">
                                <img alt="Image placeholder" src="../../../assets/img/team-3.jpg" style="padding: 3px;">
                            </a>
                            <p class="mb-0 text-sm">Kay R</p>
                        </div>
                        <div class="col-1 text-center">
                            <a href="javascript:;" class="avatar avatar-lg rounded-circle border border-primary">
                                <img alt="Image placeholder" src="../../../assets/img/team-4.jpg" style="padding: 3px;">
                            </a>
                            <p class="mb-0 text-sm">Tom M</p>
                        </div>
                        <div class="col-1 text-center">
                            <a href="javascript:;" class="avatar avatar-lg rounded-circle border border-primary">
                                <img alt="Image placeholder" src="../../../assets/img/team-5.jpg" style="padding: 3px;">
                            </a>
                            <p class="mb-0 text-sm">Nicole N</p>
                        </div>
                        <div class="col-1 text-center">
                            <a href="javascript:;" class="avatar avatar-lg rounded-circle border border-primary">
                                <img alt="Image placeholder" src="../../../assets/img/marie.jpg" style="padding: 3px;">
                            </a>
                        ...
                        <div class="col-1 text-center">
                            <a href="javascript:;" class="avatar avatar-lg rounded-circle border border-secondary">
                                <img alt="Image placeholder" src="../../../assets/img/kal-visuals-square.jpg"
                                    style="padding: 3px;">
                            </a>
            ...
            <div class="col-12 col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <img alt="Image placeholder" src="../../../assets/img/meeting.jpg"
                            class="img-fluid border-radius-lg">
                        <div class="row align-items-center px-2 mt-3">
                            <div class="col-sm-6">
                                <div class="d-flex">
                                    <a class="d-flex align-items-center" href="javascript:;">
                                        <i class="ni ni-like-2 text-secondary me-1"></i>
                                        <span class="text-dark text-sm me-3">150</span>
                                    </a>
                                    <a class="d-flex align-items-center" href="javascript:;">
                                        <i class="ni ni-chat-round text-secondary me-1"></i>
                                        <span class="text-dark text-sm me-3">36</span>
                                    </a>
                                    <a class="d-flex align-items-center" href="javascript:;">
                                        <i class="ni ni-curved-next text-secondary me-1"></i>
                                        <span class="text-dark text-sm me-2">12</span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <span class="text-dark text-sm me-2">3 likes</span>
                                        <a href="javascript:;">
                                            <i class="ni ni-curved-next text-secondary me-1"></i>
                                        </a>
                                        <span class="text-dark text-sm me-2">2 shares</span>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex mt-3">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <span class="text-dark text-sm me-2">10 likes</span>
                                        <a href="javascript:;">
                                            <i class="ni ni-curved-next text-secondary me-1"></i>
                                        </a>
                                        <span class="text-dark text-sm me-2">1 share</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card mb-3">
                    <div class="card-body pb-0">
                        <div class="row align-items-center mb-3">
                            <div class="col-9">
                                <h5 class="mb-1 text-gradient text-primary">
                                    <a href="javascript:;">#digitalmarketing</a>
                                </h5>
                            </div>
                        ...
                        <ul class="list-unstyled mx-auto">
                            ...
                            <hr style="opacity:0.5;" class="horizontal dark">
                            <li class="d-flex">
